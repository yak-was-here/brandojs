...
<p align="center">
<a href="https://www.npmjs.com/package/{{ pkg.name }}"><img alt="npm" src="https://img.shields.io/npm/v/{{ pkg.name }}?style=flat-square"></a> <a href="https://github.com/{{ socialHandles.github }}/{{ pkg.name }}/blob/master/LICENSE"><img alt="NPM" src="https://img.shields.io/npm/l/{{ pkg.name }}?style=flat-square"></a>
</p>
<p align="center">
